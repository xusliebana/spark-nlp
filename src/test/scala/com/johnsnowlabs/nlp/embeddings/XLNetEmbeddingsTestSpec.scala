...
class XLNetEmbeddingsTestSpec extends FlatSpec {
  "XLNet Embeddings" should "generate annotations" in {
    ...
    val xlnet_model_path = "/home/loan/Documents/JohnSnowLabs/spark-nlp-training/python/tensorflow/xl_net/exported_XLNET"
    ...
    val xlnetSavedModel = XLNetEmbeddings.loadSavedModel(xlnet_model_path, SparkNLP.start())
      .setBatchSize(2)
    ...
    xlnetSavedModel.write.overwrite().save("./tmp_xlnet_tf")

    val embeddings = XLNetEmbeddings.load("./tmp_xlnet_tf")
